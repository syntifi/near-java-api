...
import com.syntifi.near.api.rpc.service.contract.*;
...
public interface StakingService {
     ...
     */
    @ContractMethod(type = MethodType.VIEW, name="get_account_total_balance")
    ...
    @ContractMethod(type = MethodType.VIEW, name="get_account_staked_balance")
    ...
    @ContractMethod(type = MethodType.VIEW, name="get_account_unstaked_balance")
    ...
    @ContractMethod(type = MethodType.VIEW, name="is_account_unstaked_balance_available")
    ...
    @ContractMethod(type = MethodType.VIEW, name="get_total_staked_balance")
    ...
    @ContractMethod(type = MethodType.VIEW, name="get_unclaimed_reward")
    ...
    @ContractMethod(type = MethodType.VIEW, name="get_pool_summary")
