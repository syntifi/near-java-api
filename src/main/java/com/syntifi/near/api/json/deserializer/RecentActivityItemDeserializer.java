...
import com.syntifi.near.api.model.helper.RecentActivityArgAddKey;
import com.syntifi.near.api.model.helper.RecentActivityArgCreateAccount;
import com.syntifi.near.api.model.helper.RecentActivityArgDeleteAccount;
import com.syntifi.near.api.model.helper.RecentActivityArgDeleteKey;
import com.syntifi.near.api.model.helper.RecentActivityArgDeployContract;
import com.syntifi.near.api.model.helper.RecentActivityArgFunctionCall;
import com.syntifi.near.api.model.helper.RecentActivityArgStake;
import com.syntifi.near.api.model.helper.RecentActivityArgTransfer;
import com.syntifi.near.api.model.helper.RecentActivityItem;
import com.syntifi.near.api.model.helper.RecentActivityPermission;
...
public class RecentActivityItemDeserializer extends JsonDeserializer<RecentActivityItem> {
    public RecentActivityItem deserialize(JsonParser p, DeserializationContext ctxt)
        ...
        if (RecentActivityItem.RecentActivityActionKind.CREATE_ACCOUNT.equals(recentActivityItem.getActionKind())) {
            ...
            throw new NearServiceException(
